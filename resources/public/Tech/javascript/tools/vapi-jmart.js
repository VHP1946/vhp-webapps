...
export var GETjapitest=()=>{
  return new Promise((res,rej)=>{
      ...
      return res(SENDrequestapi(wopull,'OLDSTORE',{request:'jmart'}).then(
        answr=>{
          console.log(answr)
        }));
  });
...
export var GETflbook=(book='RES',table='flatratebook')=>{
    return new Promise((res,rej)=>{
        ...
        return res(SENDrequestapi(opts,'OLDSTORE',{request:'jmart'}));
    })
}
export var GETscontract=(custcode,table='contracttable')=>{
  return new Promise((resolve,reject)=>{
      ...
      let contract=null;
      SENDrequestapi(opts,'OLDSTORE',{request:'jmart'}).then(
        result=>{
                    ...
                    SENDrequestapi({
                      ...
                      answr=>{
                        ...
                        SENDrequestapi({
                            ...
                            template:'AR_CustomerMaster_tbl',
                            where:[{OP:'=',CustomerCode:wo.custcode}]
                        },'OLDSTORE',{request:'jmart'}).then( //bring in customer name
                          answr=>{
      ...
      SENDrequestapi(opts,'OLDSTORE',{request:'jmart'}).then(
        result=>{
          if(result.body.success){
            ...
            SENDrequestapi(opts2,'OLDSTORE',{request:'jmart'}).then(
              answr=>{
